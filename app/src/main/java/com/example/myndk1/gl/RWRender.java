...
import com.example.myndk1.R;
import com.example.myndk1.gl.glsl.RWShaderUtil;
...
public class RWRender implements GLSurfaceView.Renderer {
    ...
    {
        String vertexSource = RWShaderUtil.readRawTxt(context, R.raw.vertex_shader);
        String fragmentSource = RWShaderUtil.readRawTxt(context, R.raw.fragment_shader);
        program_yuv = RWShaderUtil.createProgram(vertexSource, fragmentSource);
